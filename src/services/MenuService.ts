...
export class MenuService {
  ...
  constructor() {
    // Inicialize os dados do cardápio aqui (ou carregue de um banco de dados).
    this.menuData = {
      bebidas: {
        semAlcool: {
        ...
        comAlcool: {
          caipirinha: [{ id: 1, name: 'Caipirinha de Limão', price: 8.00 }, { id: 2, name: 'Caipirinha de Morango', price: 9.00 }],
